...
def current_accuracy(root_node, test_data=[], test_label=[]):
    """
    计算当前决策树在训练数据集上的正确率
...
def run_test():
    ...
    decision_tree = cartTree.cart_tree(train_data, title, train_label)
    decision_tree = post_pruning(decision_tree=decision_tree, test_data=test_data, test_label=test_label,
